...
import com.dolphin.learning.springboot.manager.CityManager;
...
public class CityMapperTest extends BaseTest {
    ...
    public void testInit(){
        JSONObject provinceObject = JSONObject.parseObject("{\n" +
        ...
        JSONObject cityObject = JSONObject.parseObject("{\n" +
                "      \"安徽\":{\n" +
        ...
        Set<String>  provinceSet = provinceObject.keySet();
        for(String province :provinceSet){
            City city = new City();
            city.setName(province);
            city.setShortCode(provinceObject.getString(province));
            city.setParentId(0L);
            System.out.println(province);
            cityManager.insert(city);
            System.out.println(city.getId());
            JSONObject jsonObject = cityObject.getJSONObject(province);

            for(String cityStr :jsonObject.keySet()){
                City city1 = new City();
                city1.setName(cityStr);
                city1.setShortCode(jsonObject.getString(cityStr).split("\\|")[0]);
                city1.setParentId(city.getId());
                System.out.println(cityStr);
                cityManager.insert(city1);
    ...
    public void testInsertHouse(){
        //爬取页面
        List<City> cityList = cityManager.findChildList();
        System.out.println(cityList.size());
        System.out.println(cityList);
        for(City city : cityList){
            String url = String.format("https://%s.58.com/ershoufang/",city.getShortCode());
